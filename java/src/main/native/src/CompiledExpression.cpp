...
JNIEXPORT jlongArray JNICALL Java_ai_rapids_cudf_ast_CompiledExpression_computeColumnsJitNative(
  JNIEnv* env, jclass, jlongArray j_asts, jlong j_table)
{
  ...
  JNI_TRY
  {
    ...
    auto result           = cudf::compute_columns_jit(*tview_ptr, expressions);
